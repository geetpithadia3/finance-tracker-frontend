...
export const BudgetCategory = ({ categoryName, limit, spent }) => {
  ...
  return (
    <Card className="p-2 sm:p-3 w-full max-w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
      <div className="flex justify-between items-center mb-1 sm:mb-1.5">
        <h3 className="text-xs sm:text-sm font-medium">{categoryName}</h3>
